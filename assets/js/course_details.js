...
<svg width="320" height="180" viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg">
  ...
  // Fallback handler so lesson edit icons work consistently in all views
  // (admin and instructor), even if outline events fail to attach.
